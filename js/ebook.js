...
$(function () {
    ...
    var book_data = [
        {
            text: [
                '<div class="cover" style="background: url(img/ebook/cover.png); background-size: 100%,20%">' +
                '<div class="book_text">'
            ],
            type: 0,
            page: 1
        ...
        {
            text: [
                '<div class="cover" style="background: url(img/ebook/con1.png) no-repeat; background-size: 100%, 460px;">' +
                '<div class="book_text">'
            ],
            type: 0,
            page: 2
        ...
        {
            text: [
                '<div class="cover" style="background: url(img/ebook/con2.png) no-repeat; background-size: 100%, 460px;>' +
                '<div class="book_text">'
            ],
            type: 0,
            page: 3
        ...
        },
        {
            text: [
                ...
                '<div><h2 class="danyuan" style="margin-left:70px;">单元导语</h2></div>' +
                ...
                '<div><h2 class="yuedu" style="margin-left:70px;">阅读指南</h2></div>' +
        ...
        {
            text: [
                '<div><h1 class="title">桃花<ruby>坞<rt>wu</rt></ruby></h1></div>' +
                '<div><h2 class="subtitle" page="6">我了解</h2></div>' +
                '<div><img id="pic0" class="img" src="img/ebook/1-3.png"></div>' +
                '<div><p id="text0" class="text_pl">桃花坞，指苏州市桃花坞大街和周边地区。也有说桃花坞是包括东起报恩寺，西至阊门横街，南至下塘街神仙庙，北至唐寅坟双荷花池一带的总称。</p></div>' +
                '<div><p id="text1" class="text_pl">宋范成大《阊门泛<ruby>槎<rt style="font-size:18px;">chá</rt></ruby>》诗有“桃坞论今昔”句,明唐寅《桃花庵歌》中有“桃花坞里桃花庵,桃花庵里桃花仙”句,可见“桃花坞”名称由来已久。</p></div>'
            ],
            type: 2,
            shows: ["pic0", "text0", "text1", "text2", "pic1", "text3", "pic2", "pic3", "imgtitle", "pic4"],
            page: 6
        },
        {
            text: [
                '<div><p id="text2" class="text_pl">桃花坞又简称为桃坞。谢家福有本专门记载桃花坞一带人文历史的书就叫《桃坞名胜记》。在人民路接驾桥西面的东中市曾经有过一家电影院叫桃坞影剧院。</p></div>' +
                '<div><img id="pic1" class="img" src="img/ebook/1-7.png"></div>' +
                '<div><p id="text3" class="text_pl">历史上的桃花坞几经兴废。近年来，苏州倾力打造桃花坞历史文化片区。目前，唐寅故居文化区已基本建成，主要包括唐寅故居遗址、唐寅祠、文昌阁等。' +
        ...
        },
        {
            //need work with imgs
            text: [
                '<div><img id = "pic2" class="img" src="img/ebook/1-4.png" ><div id = "imgtitle" class="imgTitle">唐寅故居</div></div>' +
                '<div><img id = "pic3" class="flexImg" style="margin-left:80px; margin-top:380px" src="img/ebook/1-5.png"></div>' +
                '<div><img id = "pic4" class="flexImg" style="margin-left:240px; margin-top:480px" src="img/ebook/1-6.png"></div>'
            ],
            type: 2,
            page: 8
        },
        {
            text: [
                '<div><h2 class="subtitle" page="9">我标记</h2></div>' +
                '<div><p id="text4" class="text_pl">在地图上找一找“苏州市桃坞中心小学校”在哪里？唐寅故居在哪里？阊门西街在哪里？用彩色笔标记出来。</p></div>' +
                '<div><img id="pic5" class="img" src="img/ebook/1-8.png"></div>'
            ],
            type: 1,
            shows: ["text4", "pic5"],
            page: 9
        },
        {
            text: [
                ...
                '<div><h2 class="subtitle" page="10">我了解</h2></div>' +
                '<div><p id="text5" class="text_pl">桃花坞木版年画是我国南方流传最广、影响最大的一种民间木刻画。因为曾经集中在苏州城内桃花坞一带生产而得名。</p></div>' +
                '<div><p id="text6" class="text_pl">桃花坞木版年画和河南朱仙镇、天津杨柳青、山东潍坊杨家埠、四川绵竹的木版年画，并称为中国五大民间木版年画。</p></div>' +
                '<div><p id="text7" class="text_pl">桃花坞年画源于宋代的雕版印刷工艺，由绣像图演变而来，到明代发展成为民间艺术流派，清代雍正、乾隆年间为鼎盛时期，每年出产的桃花坞木版年画达百万张以上。</p></div>' +
                '<div><p id="text8" class="text_pl">桃花坞木版年画构图对称、丰满,色彩绚丽,常以紫红色为主调表现欢乐气氛,基本全用套色制作,刻工、色彩和造型具有精细秀雅的江南地区民间艺术风格,主要表现吉祥喜庆、民俗生活、戏文故事、花鸟蔬果和驱鬼避邪等中国民间传统审美内容,民间画坛称为“姑苏版”。2006年5月20日,该遗产经国务院批准列入第一批国家级非物质文化遗产名录。</p></div>'

            ],
            type: 2,
            shows: ["text5", "text6", "text7", "text8"],
            page: 10
        },
        {
            text: [
                '<div><h2 class="subtitle" page="11">我欣赏</h2></div>' +
                '<div><img id="pic6" class="imgleft" src="img/ebook/1-12.png"><div id="txt1" class="flextitle" style="margin-left:70px;margin-top:250px;" >一团和气</div></div>' +
                '<div><img id="pic7" class="imgright" src="img/ebook/1-9.png"><div  id="txt2" class="flextitle" style="margin-left:360px;margin-top:250px;">花开富贵</div></div>' +
                '<div><img id="pic8" class="imgleft" style="margin-top:360px" src="img/ebook/1-10.png"><div id="txt3" style="margin-left:70px;margin-top:580px;" class="flextitle">姑苏城外寒山寺</div></div>' +
                '<div><img id="pic9" class="imgright"  style="margin-top:360px" src="img/ebook/1-11.png"><div id="txt4" style="margin-left:360px;margin-top:580px;" class="flextitle">新姑苏玄妙观</div></div>'
            ],
            type: 1,
            shows: ["pic6", "pic7", "pic8", "pic9", "txt1", "txt2", "txt3", "txt4"],
            page: 11
        },
        {
            text: [
                '<div><h1 class="title">读后评价</h1></div>' +
                '<div><p class="text_pl" style="display:block;">1.我知道“桃花坞”地区在哪里，能在地图上准确地标注。</p></div>' +
                '<div><p class="text_pl" style="display:block;">在互评和自评后打星：☆☆☆☆</p></div>' +
                '<div><p class="text_pl" style="display:block;">2.我能简单说说“桃花坞木版年画”的历史。</p></div>' +
                '<div><p class="text_pl" style="display:block;">在互评和自评后打星：☆☆☆☆</p></div>'
        ...
        },
        {
            text: [
                ...
                '<div><h2 class="subtitle" page="16">我了解</h2></div>' +
                '<div><p id="text21" class="text_pl">在明弘治年间，画家唐伯虎在桃花坞买下一块废墟，在园址西南处筑室，广植桃花，取名“桃花庵”。桃花庵内筑有“学圃堂”、“梦墨亭”、“蛱蝶斋”等，并将屋前池塘沿用宋时五亩园内“双荷花池”的名字，与文徵明、祝枝山等常聚此处，吟诗作画。唐寅逝后，园渐荒废。</p></div>' +
                '<div><p id="text22" class="text_pl">现经复原后故居内所有的堂、斋、室名称都出自唐寅书画作品，具有鲜明的主题色彩。故居牌匾上写“唐寅故居”四字由原中国书法协会副主席言恭达所题写。穿过大门，站在青莲桥上，东西双荷花池映入眼帘，美不胜收。</p></div>' +
                '<div><img id="pic21" class="imgleft" style="margin-left:00px;margin-top:400px;" src="img/ebook/2-4.png"></div>' +
                '<div><img id="pic22" class="imgright" style="margin-right:30px;margin-top:400px; height:140px;" src="img/ebook/2-5.png"></div>'
            ],
            type: 2,
            shows: ["text21", "text22", "pic21", "pic22"],
            page: 16
        },
        {
            text: [
                '<div><h2 class="subtitle" page="17">我实践</h2></div>' +
                '<div><p class="text_pl" id="text23">1.在休息日，邀请家长一起到唐寅故居走一走，拍下美景。</p></div>' +
                '<div><img class="img" id="pic23" src="img/ebook/2-6.png"></div>' +
                '<div><p class="text_pl" id="text24">2.搜集和唐寅有关的民间故事，讲给小伙伴听。</p></div>'
            ],
            title: "",
            type: 1,
            shows: ["text23", "pic23", "text24"],
            page: 17
        },
        {
            text: [
                '<div><h1 class="title">朴    园</h1></div>' +
                '<div><h2 class="subtitle" page="18">我了解</h2></div>' +
                '<div><p class="text_pl" id="text25">朴园位于平门内校场路8号，1991年被列为苏州市文物保护单位，现为桃花坞木版年画博物馆。朴园四周围以花岗石墙，采用传统造园布局，以山水为主景，峰峦起伏，池架曲桥，聚分兼得。园内花木茂盛，有白皮松、罗汉松、广玉兰、樱花、杜鹃等，最为珍贵的是两株地栽五针松，高约2米，生长健旺。</p></div>' +
                '<div><img class="imgleft" id="pic24" src="img/ebook/2-4.png"></div>' +
                '<div><img class="imgright" id="pic25" src="img/ebook/2-4.png"></div>'
            ],
            type: 2,
            shows: ["text25", "pic24", "pic25"],
            page: 18
        },
        {
            text: [
        ...
        },
        {
            text: [
                ...
                '<div><h2 class="subtitle" style="margin-top:200px;">诗情画意</h2></div>' +
        ...
        {
            text: [
                '<div class="page_d" style="background: url(img/ebook/4-1.png)">'
            ],
            type: 3,
            page: 52
        },
        {
            text: [
                '<div class="page_d" style="background: url(img/ebook/4-2.png)">' +
                '<div class="book_text">' +
                '<div><h1 class="title" style="margin-left:70px; margin-top:50px;">名作欣赏</h1></div>' +
                '<div><img class="circleImg" src="img/ebook/4-3.png"></div>' +
                '<div><h2 class="subtitle" style="margin-left:70px;">单元导语</h2></div>' +
                '<div><p class="text_pret" style="font-size:12px">年画是中国老百姓喜闻乐见的传统艺术形式。随着印刷技术的进步，手工木版年画逐渐成为非物质文化遗产。“北有杨柳青，南有桃花坞”，苏州桃花坞木版年画色彩饱满、 明快活泼，是我国南方年画的代表。 </p></div>' +
                '<div><p class="text_pret" style="font-size:12px">本章节收录了《一团和气》《百子婴戏图》《湖畔教子图》《门神画》《龙凤呈祥》五幅极具代表性的桃花坞木版年画作品供学生欣赏。这五福年画同时呈现在学校门厅的上方，通过本单元的名作欣赏，希冀能引导学生细细品味、耐心观摩桃花坞木版年画，主动探索其中处处隐藏的民俗风景。</p></div>' +
                '<div><h2 class="yuedu" style="margin-left:70px;">阅读指南</h2></div>' +
                '<div><p class="text_pret" style="font-size:12px">找一找桃花坞木版年画中的吉祥寓意和民俗风景。</p></div>'
            ],
            title: "",
            type: 4,
            page: 53
    ...
    function creat_html(data, num) {
        ...
        for (var i = 0; i < data.length; i++) {
            if (b_ok) {
                ...
                if (type == 1) {
var num = data[i].page-3;

                    page_html += '<div class="page_b">' +
                        '<div class="book_text">' +
                        p_text +
                        '</div>' +
                        '<p class="next_page" style="display:' + isshow + '">' + num + '  下一页</p>' +
                        '</div>'
                }
                ...
                if (type == 2) {
                    ...
                    page_html += '<div class="page_d">' +
                        ...
                        p_text +
                        '</div>' +
                        '<p class="pre_page" style="display:' + isshow + '">上一页  ' + num + '</p> ' +
                        '</div>'
                }
        ...
        $(document).on('click', '.subtitle', function () {
            ...
            // alert(page);
            var shows = data[pageindex].shows;
            // alert(pageindex);
            // alert(shows);
            // setTimeout(function(){
            for (var i = 0; i < shows.length; i++) {
                var element = document.getElementById(shows[i]);
                ...
                // element.style['animationName']='showcontent';
